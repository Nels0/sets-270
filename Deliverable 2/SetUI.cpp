...
void SetUI::printError(string reason)
{
	 ...
	 * Some examples are given below:
		1. emit an error message if the input file does not exist or contains wrong data.
		2. emit an error message if the user trying to find the equivalence class for a string that does not have equivalence relation
	*/ 
